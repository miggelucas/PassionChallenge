...
extension Place {
    ...
    static func getArtesanato() -> [Place] {
        return [
            Place(
            ...
            Place(
                tagCategorie : [K.historia, K.musica, K.literatura, K.artesanato],
    ...
    static func getCulinaria() -> [Place] {
        return [
            Place(
                tagCategorie : [K.artesanato, K.historia, K.culinaria],
                name: "Paço Alfândega",
    ...
    static func getLiteratura() -> [Place] {
        return [
            Place(
                tagCategorie : [K.artesanato, K.historia, K.culinaria],
                name: "Paço Alfândega",
    ...
    static func getCinema() -> [Place] {
        return [
            Place(
                tagCategorie : [K.cinema, K.historia],
                name: "Cinema São Luiz",
                adress: "Rua da Aurota 175, Boa Vista - Recife",
                imageURL: "cinemasaoluiz.png",
                historyArray: [
                    History(imageURL: "cinemasaoluiz1.png", text: "Inaugurado em 1952 ,  com capacidade para 992 espectadores, é um dos ultimos cinemas de Rua do Brasil, e o uníco em Recife. Tem seu estilo arquitetônico com referências à Art déco. foi construído onde antes funcionava a Capela Anglicana do Recife, ou Holy Trinity Church, construída em 1838 e demolida um século depois para a ampliação da Avenida Conde da Boa Vista."),
                    History(imageURL: "cinemasaoluiz2.png", text: "Grandes tapeçarias suspensas, que se cruzam no teto, dão um ar de um teatro majestoso. Bordados de flor-de-lis e dezasseis escudos de guerra fazem referência, respectivamente, ao Rei Luís IX e às cruzadas."),
                    History(imageURL: "cinemasaoluiz3.png", text: "Ao lado da tela dois vitrais de autoria da artista plástica Aurora de Lima, aluna de Heinrich Moser, construídos em 1951, representam jarros de flores, fazendo do São Luiz um dos poucos cinemas do mundo a ter vitrais no seu interior. "),
                    History(imageURL: "cinemasaoluiz4.png", text: "No hall de entrada encontra-se um painel de Lula Cardoso Ayres. O piso é de mármore branco, as paredes têm revestimento em jatobá e as luminárias são em bronze")],
    ...
    static func getAoArLivre() -> [Place] {
        return [
